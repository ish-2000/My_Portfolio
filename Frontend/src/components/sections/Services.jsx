...
import {
  Code2, Palette, AppWindow, LayoutTemplate,
  Sparkles, Box, PenTool,
} from 'lucide-react'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div ref={headingRef}>
            <h2 className="font-display font-medium tracking-tighter mb-8">
              <span className="block text-text-ghost" style={{ fontSize: '56px', lineHeight: '56px' }}>
                Services that
              </span>
              <span className="block text-text-primary" style={{ fontSize: '56px', lineHeight: '56px' }}>
                supercharge your business.
              </span>
            </h2>

            <div ref={techRef}>
              <p className="font-body text-sm font-semibold text-text-muted mb-4">My tech stack</p>
